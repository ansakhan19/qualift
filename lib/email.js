...
<body style="margin:0;padding:0;background:#f8f8fc;font-family:Inter,system-ui,sans-serif">
  <div style="max-width:480px;margin:32px auto;background:white;border-radius:16px;border:1px solid #e5e7eb;overflow:hidden">
    ...
    <div style="padding:28px">
      ...
      <p style="font-size:14px;color:#64748b;line-height:1.6;margin:0 0 24px">
        Click below to pick up exactly where you left off${stage ? `, <strong style="color:#3730A3">${stage}</strong>` : ''}.
        Works on any device, any browser.
      </p>

      <a href="${link}" style="display:block;background:#4F46E5;color:white;text-decoration:none;text-align:center;padding:14px 24px;border-radius:10px;font-size:15px;font-weight:500;margin-bottom:20px">
  ...
  // Resend does NOT throw on API errors, it returns { error }. Surface it.
